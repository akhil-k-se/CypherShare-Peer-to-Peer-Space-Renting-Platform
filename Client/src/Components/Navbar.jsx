    ...
    <>
      ...
      <div className="relative w-full flex items-center justify-center">
        <div className="flex flex-col items-center justify-center z-40">
          ...
          <div className="top-6 left-3 absolute z-40 nav1 font-orbitron xl:text-4xl select-none pointer-events-none hidden lg:block text-2xl xl:top-5">
            CypherShare
          </div>
        </div>
      </div>
...
function Navbar({ className }) {
  ...
  return (
    <div className={cn("fixed top-2 inset-x-0 max-w-2xl mx-auto z-50 font-montserrat", className)}>
